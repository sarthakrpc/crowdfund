...
export default async (req, res) => {
  if (req.method === "POST") {
    ...
    try {
      ...
      const folderName = `public/projectAssets/${folder}`;
      ...
      const pathToWriteImage = `public/projectAssets/${folder}/${fileName}`; // include name and .extention, you can get the name from data.files.image object
